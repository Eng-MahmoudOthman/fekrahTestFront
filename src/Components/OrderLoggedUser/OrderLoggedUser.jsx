...
export default function OrderLoggedUser({socket}) {
   ...
   async function submitOrder(values){
      ...
      if(response?.data.message === "success"){
         ...
         // toast.success(`${data.message == "success"? "Success" : ""} Complete Order`) ;
   ...
   return (
      <Fragment>
         <div className="w-75 p-2 m-auto  OrderLoggedUser ">
            <h1 className="main-header">Logged Patient</h1>
