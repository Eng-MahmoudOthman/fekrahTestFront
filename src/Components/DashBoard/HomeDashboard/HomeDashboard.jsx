   ...
   return (
      <Fragment>
         ...
         <div className="container-fluid homeDashboard">
            <h4 className='text-center border-2 border-bottom py-2 fw-bold'>Site Statistics Today</h4>
                        ...
                        {orders.slice(0 , countItem).map((ele)=>
                           <tr key={ele._id}>
                              ...
                              <td>
                              {
                                 ...
                                 : ele.is_Paid_Invoice_V_Cash &&  ele.is_Paid  &&   !ele.is_wrong_Invoice_V_Cash || ele.is_Paid  &&   !ele.is_wrong_Invoice_V_Cash?
