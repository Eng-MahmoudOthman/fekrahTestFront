...
export default function Register(){
   ...
   return (
      <Fragment>
         <div className="register-container p-5 m-auto mt-5">
            ...
            <form action="" onSubmit={formik.handleSubmit}>
               ...
               <div className="d-grid gap-2 col-8 mx-auto">
                  ...
                  <p className="login-text text-center mt-1">Don't have an account?<Link className="m-2 text-primary" to="/" >  Log in </Link></p>
               </div>
